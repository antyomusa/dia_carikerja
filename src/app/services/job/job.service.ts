...
export class JobService {
  ...
  putApplyJob(body: any, data: any): Observable<any> {
    ...
    return this.http.put('http://54.251.83.205:9091/api/v1/jobseeker/job/apply', formData);
  }

  public getAppliedDetailJob(body: any, data: any): Observable<unknown> {
    const params = new HttpParams()
      .set("jobId", body.jobId)
      .set("jobseekerId", data.jobseekerId);
    return this.http.get('http://54.251.83.205:9091/v1/application/job/applied/detail', { params: params });
  }
}
